...
`d-preview <https://preview.d-portal.org/upload>`_ is a tool which generates a private preview of an IATI XML file. Using the same interface as d-portal, d-preview allows users to “proof-read” their IATI XML before publication.
