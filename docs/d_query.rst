...
`Dquery <https://d-portal.iatistandard.org/dquery/>`_ provides a read only SQL interface to the d-portal database. This includes non-standard attributes and extensions to the IATI Standard which are not displayed by the d-portal site. 
